...
const CLASS_HUD = createClassStableId({ imageStableId: IMAGE_A, namespace: 'Ui', className: 'Hud' });
const CLASS_ENEMY = createClassStableId({ imageStableId: IMAGE_B, namespace: 'Gameplay', className: 'Enemy' });
...
const sampleClassDescriptor: ClassDescriptor = {
  ...
  inheritance: [],
  staticFields: [
    { stableId: STATIC_INSTANCE, name: 'Instance', fieldType: 'Gameplay.PlayerController', offset: null, address: '0x1000', value: 'null' },
  ],
  fields: [
    { stableId: FIELD_HEALTH, offset: '10', name: 'health', fieldType: 'System.Int32' },
    { stableId: FIELD_SPEED, offset: '14', name: 'speed', fieldType: 'System.Single' },
  ],
  methods: [
    {
...
const sampleRuntimeOverlay: RuntimeClassOverlayDescriptor = {
  ...
  staticFields: [
    { stableId: STATIC_RUNTIME_MESSAGE, name: 'objectIsNullMessage', fieldType: 'System.String', offset: null, address: '0x2000', value: '?' },
    { stableId: STATIC_INSTANCE, name: 'Instance', fieldType: 'Gameplay.PlayerController', offset: null, address: '0x1000', value: '0x1234' },
  ],
  fields: [
    { stableId: FIELD_RUNTIME_CACHED_PTR, offset: '0x10', name: 'm_CachedPtr', fieldType: 'System.IntPtr' },
    { stableId: FIELD_HEALTH, offset: '10', name: 'health', fieldType: 'System.Int32' },
  ],
};
...
describe('studio editor catalog', () => {
  ...
  it('builds a searchable class catalog sorted by assembly and namespace', () => {
    const entries = buildStudioClassCatalog(
      [
        { stableId: IMAGE_B, name: 'Zeta.dll', path: 'Zeta.dll' },
        { stableId: IMAGE_A, name: 'Assembly-CSharp.dll', path: 'Assembly-CSharp.dll' },
      ],
      {
        [IMAGE_B]: [{ stableId: CLASS_ENEMY, imageStableId: IMAGE_B, name: 'Enemy', namespace: 'Gameplay', fullName: 'Gameplay.Enemy', imageName: 'Zeta.dll' }],
        [IMAGE_A]: [
          { stableId: CLASS_HUD, imageStableId: IMAGE_A, name: 'Hud', namespace: 'Ui', fullName: 'Ui.Hud', imageName: 'Assembly-CSharp.dll' },
          { stableId: CLASS_PLAYER, imageStableId: IMAGE_A, name: 'PlayerController', namespace: 'Gameplay', fullName: 'Gameplay.PlayerController', imageName: 'Assembly-CSharp.dll' },
        ],
      },
    );
    ...
    const entries = buildStudioClassCatalog(
      [{ stableId: IMAGE_A, name: 'Assembly-CSharp.dll', path: 'Assembly-CSharp.dll' }],
      {
        [IMAGE_A]: [
          { stableId: CLASS_PLAYER, imageStableId: IMAGE_A, name: 'PlayerController', namespace: 'Gameplay', fullName: 'Gameplay.PlayerController', imageName: 'Assembly-CSharp.dll' },
          {
            stableId: createClassStableId({ imageStableId: IMAGE_A, namespace: 'Cinematics', className: 'CameraRig' }),
            imageStableId: IMAGE_A,
            name: 'CameraRig',
  ...
  it('normalizes malformed class info catalogs from persisted data', () => {
    const catalog = normalizeClassInfoCatalog({
      members: [
        { id: FIELD_HEALTH, label: 'health', name: 'health', typeName: 'System.Int32', offset: '0x10', address: null, value: null, isStatic: false },
        { id: 123 },
      ],
      statics: 'invalid',
      functions: [{
