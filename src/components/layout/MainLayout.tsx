...
export function MainLayout({ children }: MainLayoutProps) {
    return (
        <div data-tauri-drag-region className="h-screen w-screen bg-[#0e1620] text-slate-200 flex flex-col font-sans overflow-hidden relative shadow-[inset_0_0_20px_rgba(6,182,212,0.05)] border border-cyan-500/10 rounded-xl select-none">
