...
interface SceneInspectorTabBarProps {
  tabs: SceneInspectorTab[];
  activeTabIndex: number;
  setActiveTabIndex: (index: number) => void;
  handleCloseTab: (index: number, e: MouseEvent) => void;
}

export const SceneInspectorTabBar = memo(function SceneInspectorTabBar({
  tabs,
  activeTabIndex,
  setActiveTabIndex,
  handleCloseTab,
}: SceneInspectorTabBarProps) {
    ...
    >
      <AnimatePresence>
        {tabs.map((tab, idx) => {
          ...
          const Icon = Box; // Using Box as the default icon for GameObjects

          return (
            <motion.div
              key={tab.objectAddress}
