import { getProjectedInstanceReferencePayloadFromValue } from '@/features/studio/core/contracts';
import { createLiteralExpressionSource, resolveExpressionSource } from '@/features/studio/core/expression';
import { formatHexAddress, isExplicitHexAddress } from '@/core/addressFormat';
import type { ExpressionResolutionContext } from '@/features/studio/core/expression';
import type {
  ExpressionSource,
  ExpressionValueType,
