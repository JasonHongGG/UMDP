...
import { createJsonPort, createParameterDefinitionsEnvelope, PARAMETER_DEFINITIONS_SCHEMA } from '@/features/studio/core/contracts';
import { defineStudioNode } from '@/features/studio/core/NodeRegistry';
import { Port } from '@/features/studio/components/canvas/Port';
import { getExpressionSourceDisplayValue, readExpressionDragData } from '@/features/studio/core/expression';
...
function buildParametersNodeQuerySnapshot(
  node: import('@/features/studio/core/types').StudioNode<ParametersNodeData>,
