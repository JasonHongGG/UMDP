...
import { createEnvelope, createFlowPort, createJsonPort, GENERIC_JSON_SCHEMA } from '@/features/studio/core/contracts';
...
import { resolveExpressionSource } from '@/features/studio/core/expression';
import type { StudioNodeLifecycleContext } from '@/features/studio/core/nodeCapabilities';
import type {
  INodeComponentProps,
  IPort,
...
function getForLoopResolvedCountCandidate(source: ForLoopNodeData['countSource'], context: {
  snapshots?: Record<string, import('@/features/studio/core/types').NodeExecutionSnapshot>;
...
function resolveForLoopSynchronizedSource(
  node: import('@/features/studio/core/types').StudioNode<ForLoopNodeData>,
...
function resolveCountForQuery(node: import('@/features/studio/core/types').StudioNode<ForLoopNodeData>, context: StudioNodeQueryContext) {
