...
import { createFlowPort, createJsonPort, GENERIC_JSON_SCHEMA } from '@/features/studio/core/contracts';
...
import { resolveExpressionSource, getExpressionSourceDisplayValue } from '@/features/studio/core/expression';
import type {
  INodeComponentProps,
  IPort,
...
function buildIfNodeQueryState(
  node: import('@/features/studio/core/types').StudioNode<IfNodeData>,
