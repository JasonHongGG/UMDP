...
function buildEditorQueryState(
  node: import('@/features/studio/core/types').StudioNode<EditorNodeData>,
  ...
  const snapshotMap: Record<string, import('@/features/studio/core/types').NodeExecutionSnapshot> = {
